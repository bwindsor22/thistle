...
use crate::hnswlib::api::*;
use crate::hnswlib::dist::*;
use crate::hnswlib::hnsw::*;
use crate::hnswlib::hnswio::*;
...
#[repr(C)]
/// The basic Neighbor info returned by api
pub struct Neighbor_api {
    /// id of neighbour
    pub id  : usize,
...
impl From<&Neighbor> for Neighbor_api {
    fn from(neighbour : &Neighbor) -> Self {
        Neighbor_api{ id : neighbour.d_id, d: neighbour.distance}
    }
}
...
pub struct Neighborhood_api {
    pub nbgh : i64,
    pub neighbours : *const Neighbor_api,
}



#[repr(C)]
pub struct Neighbor_api_parsearch_answer {
    /// The number of answers (o request), i.e size of both vectors nbgh and neighbours
    pub nb_answer : usize,
    /// for each request, we get a Neighborhood_api
    pub neighbourhoods : *const Neighborhood_api,
}
...
crate::declare_myapi_type!(HnswApif32, f32);
crate::declare_myapi_type!(HnswApif64, f64);
...
($function_name:ident, $api_name:ty, $type_val:ty) => (
        ...
        pub extern "C" fn $function_name(hnsw_api : *const $api_name, len:usize, data : *const $type_val, 
            ...
            let neighbours_api : Vec<Neighbor_api> = neighbours.iter().map(|n| Neighbor_api::from(n)).collect();
...
($function_name:ident, $api_name:ty, $type_val:ty) => (
        ...
        pub extern "C" fn $function_name(hnsw_api : *const $api_name, nb_vec : usize, vec_len :i64, 
                            data : *mut *const $type_val, knbn : usize, ef_search : usize) ->  *const Vec_api<Neighborhood_api> {
            //
            ...
            let neighbours : Vec<Vec<Neighbor> >; 
            let mut data_v = Vec::<Vec<$type_val>>::with_capacity(nb_vec);
            unsafe {
            ...
            // construct a vector of Neighborhood_api
            // reverse work, construct 2 arrays, one vector of Neighbors, and one vectors of number of returned neigbours by input a vector.
            let mut neighbour_lists = Vec::<Neighborhood_api>::with_capacity(nb_vec);
            for v in neighbours {
                let neighbours_api : Vec<Neighbor_api> = v.iter().map(|n| Neighbor_api::from(n)).collect();
                let nbgh = neighbours_api.len();
                let neighbours_api_ptr = neighbours_api.as_ptr();
                std::mem::forget(neighbours_api);
                let v_answer = Neighborhood_api {
                        nbgh : nbgh as i64,
            ...
            let answer = Vec_api::<Neighborhood_api> {
                len : nb_vec as i64,
...
// f32
generate_loadhnsw!(load_hnswdump_f32_DistL1, HnswApif32, f32, crate::hnswlib::dist::DistL1);
generate_loadhnsw!(load_hnswdump_f32_DistL2, HnswApif32, f32, crate::hnswlib::dist::DistL2);
generate_loadhnsw!(load_hnswdump_f32_DistCosine, HnswApif32, f32, crate::hnswlib::dist::DistCosine);
generate_loadhnsw!(load_hnswdump_f32_DistDot, HnswApif32, f32, crate::hnswlib::dist::DistDot);
generate_loadhnsw!(load_hnswdump_f32_DistJensenShannon, HnswApif32, f32, crate::hnswlib::dist::DistJensenShannon);
generate_loadhnsw!(load_hnswdump_f32_DistJeffreys, HnswApif32, f32, crate::hnswlib::dist::DistJeffreys);

// i32
generate_loadhnsw!(load_hnswdump_i32_DistL1, HnswApii32, i32, crate::hnswlib::dist::DistL1);
generate_loadhnsw!(load_hnswdump_i32_DistL2, HnswApii32, i32, crate::hnswlib::dist::DistL2);
generate_loadhnsw!(load_hnswdump_i32_DistHamming, HnswApii32, i32, crate::hnswlib::dist::DistHamming);

// u32
generate_loadhnsw!(load_hnswdump_u32_DistL1, HnswApiu32, u32, crate::hnswlib::dist::DistL1);
generate_loadhnsw!(load_hnswdump_u32_DistL2, HnswApiu32, u32, crate::hnswlib::dist::DistL2);
generate_loadhnsw!(load_hnswdump_u32_DistHamming, HnswApiu32, u32, crate::hnswlib::dist::DistHamming);
generate_loadhnsw!(load_hnswdump_u32_DistJaccard, HnswApiu32, u32, crate::hnswlib::dist::DistJaccard);

// u16
generate_loadhnsw!(load_hnswdump_u16_DistL1, HnswApiu16, u16, crate::hnswlib::dist::DistL1);
generate_loadhnsw!(load_hnswdump_u16_DistL2, HnswApiu16, u16, crate::hnswlib::dist::DistL2);
generate_loadhnsw!(load_hnswdump_u16_DistHamming, HnswApiu16, u16, crate::hnswlib::dist::DistHamming);
generate_loadhnsw!(load_hnswdump_u16_DistLevenshtein, HnswApiu16, u16, crate::hnswlib::dist::DistLevenshtein);

// u8
generate_loadhnsw!(load_hnswdump_u8_DistL1, HnswApiu8, u8, crate::hnswlib::dist::DistL1);
generate_loadhnsw!(load_hnswdump_u8_DistL2, HnswApiu8, u8, crate::hnswlib::dist::DistL2);
generate_loadhnsw!(load_hnswdump_u8_DistHamming, HnswApiu8, u8, crate::hnswlib::dist::DistHamming);
generate_loadhnsw!(load_hnswdump_u8_DistJaccard, HnswApiu8, u8, crate::hnswlib::dist::DistJaccard);


// Reload only graph
generate_loadhnsw!(load_hnswdump_NoData_DistNoDist, HnswApiNodata, NoData, crate::hnswlib::dist::NoDist);
...
crate::declare_myapi_type!(HnswApii32, i32);
...
crate::declare_myapi_type!(HnswApiu32, u32);
...
crate::declare_myapi_type!(HnswApiu16, u16);
...
crate::declare_myapi_type!(HnswApiu8, u8);
...
fn make_readers(basename: &String) -> (BufReader<std::fs::File>, BufReader<std::fs::File>) {
    ...
    if graphfileres.is_err() {
        ...
        panic!("make_readers : could not open file");            
    }
