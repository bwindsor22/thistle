...
use crate::database::lsh_db::LshDB;
use crate::hnswlib::*;
...
pub fn new(db_method: &str) -> DB {
    match db_method {
        ...
        "LSH" => DB::LshDB(LshDB{ docs: Vec::new(), lsh: LshMem::new(1, 1, 1) }),
